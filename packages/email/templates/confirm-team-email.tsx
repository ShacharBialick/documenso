...
export const ConfirmTeamEmailTemplate = ({
  ...
  const previewText = msg`Accept team email request for ${teamName} on TheOSCompany Signing Service`;
            ...
            <Section className="p-2 text-muted-foreground">
              ...
              <Text className="text-center text-base">
                <Trans>
                  ...
                  on TheOSCompany Signing Service.
                </Trans>
              </Text>
              ...
              <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can revoke access at any time in your team settings on TheOSCompany Signing Service{' '}
