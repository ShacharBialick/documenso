  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using TheOSCompany Signing Service to perform your electronic document signing. The purpose of this disclosure is
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by TheOSCompany Signing Service, you affirm that you have read
